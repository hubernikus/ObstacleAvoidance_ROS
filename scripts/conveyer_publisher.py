...
class obstaclePublisher():
    def __init__(self, a=[1,1,1], p=[1,1,1], x0=[0,0,0], th_r=[0,0,0], sf=1, sigma=1, dx=[0,0,0], w=[0,0,0], init_disp=[0,0,0]):
        ...
        # Create publishers
        elli_pub = rospy.Publisher('convey_poly', PolygonStamped, queue_size=5)
        obs_pub = rospy.Publisher('convey', Obstacle, queue_size=5)
        ...
        while not rospy.is_shutdown():
            ...
            if self.itCount > N_pubInterval:
                ...
                rospy.loginfo("100 conveyer published".format(N_pubInterval))
                self.itCount=0
