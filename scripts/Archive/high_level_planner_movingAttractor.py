...
class HighLevelController():
    def __init__(self):
        ...
        # Pickup positions
        self.pos_pickup = [[0.200, 0.44, 0.45],
                           [-0.618,-0.267,0.214]]

        self.pos_dropoff = [[-.28,-0.450,0.330],
                           [-0.618,-0.267,0.214]]
        ...
        while not rospy.is_shutdown():
            ...
            if self.controlMode=='dropoff_xy': #higher up
                ...
                x0_attr = qv_mult(self.attrObs_quat, self.attr_obs.x0)
            ...
            #################### DROP OFF ####################
                ...
                x0_attr = qv_mult(self.attrObs_quat, self.attr_obs.x0)
                pos_goal = self.pos_attr + x0_attr
